# Require our stack
%w(essential apache scm ruby libxml memcached postgresql mysql rails).each do |r|
...
policy :passenger_stack, :roles => :app do
  ...
  requires :libxml                  # libxml2 (required by Nokogiri)
  requires :libxslt                 # libxslt (required by Nokogiri)
